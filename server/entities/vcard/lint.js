...
import { isAtDepthPositionKey } from "./worldbookPositions.js";
import { resolveFindRegex, tryCompileRegex } from "./regexUtils.js";
import { normalizeVibePlan, pickVibePlanCurrent, summarizeVibePlanIssues } from "./vibePlan.js";
...
function buildCurrentTaskProgress(plan, picked) {
  ...
  return { stepIndex: currentIndex, stepName, totalSteps: steps.length || 1, steps, nextAction };
}
